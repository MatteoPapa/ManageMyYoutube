...
class AffiliationsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create affiliation" do
    assert_difference("Affiliation.count") do
      post affiliations_url, params: { affiliation: { cliente: @affiliation.cliente, manager: @affiliation.manager, status: @affiliation.status } }
    end
  ...
  test "should update affiliation" do
    patch affiliation_url(@affiliation), params: { affiliation: { cliente: @affiliation.cliente, manager: @affiliation.manager, status: @affiliation.status } }
